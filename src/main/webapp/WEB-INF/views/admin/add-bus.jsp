...
<html lang="vi">
    <head>
        ...
        <title>Thêm Xe Buýt Mới - Admin</title>
        ...
        <div class="main-content">
            ...
            <main class="content-body">
                ...
                <div class="card">
                    ...
                    <form action="<c:url value='/admin/buses/add'/>" method="post">
                        <div class="form-group">
                            <label for="licensePlate"><i class="fas fa-id-card"></i> Biển số xe</label>
                            <input type="text" id="licensePlate" name="licensePlate" placeholder="Ví dụ: 29B-123.45" required>
                        </div>
                        <div class="form-group">
                            <label for="capacity"><i class="fas fa-users"></i> Số ghế</label>
                            <input type="number" id="capacity" name="capacity" placeholder="Ví dụ: 29" required min="1">
                        </div>
                        <div class="form-group">
