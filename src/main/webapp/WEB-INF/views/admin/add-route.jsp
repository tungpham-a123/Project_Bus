...
<html lang="vi">
    <head>
        ...
        <title>Thêm Tuyến Xe Mới - Admin</title>
            ...
            <main class="content-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2>Thêm tuyến xe mới</h2>
                    </div>

                    <form action="<c:url value='/admin/routes/add'/>" method="post">
                        <div class="form-group">
                            <label for="routeName"><i class="fas fa-road"></i> Tên tuyến xe</label>
                            <input type="text" id="routeName" name="routeName" placeholder="Ví dụ: Tuyến số 1 - Quận Ba Đình" required>
                        </div>
                        <div class="form-group">
                            <label for="description"><i class="fas fa-info-circle"></i> Mô tả</label>
                            <textarea id="description" name="description" rows="4" placeholder="Nhập mô tả ngắn gọn về lộ trình của tuyến xe..."></textarea>
                        </div>

                        <div class="form-actions">
                            <a href="<c:url value='/admin/routes'/>" class="btn btn-secondary">
