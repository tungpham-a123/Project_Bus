...
<html lang="vi">
    <head>
        ...
        <title>Thêm Điểm Dừng Mới - Admin</title>
            ...
            <main class="content-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2>Tạo điểm dừng mới</h2>
                    </div>

                    <form action="<c:url value='/admin/stops/add'/>" method="post">
                        <div class="form-group">
                            <label for="stopName"><i class="fas fa-sign"></i> Tên điểm dừng</label>
                            <input type="text" id="stopName" name="stopName" placeholder="Ví dụ: Cổng chính KĐT Times City" required>
                        </div>
                        <div class="form-group">
                            <label for="address"><i class="fas fa-map-marked-alt"></i> Địa chỉ chi tiết</label>
                            <textarea id="address" name="address" rows="3" placeholder="Ví dụ: 458 Minh Khai, Phường Vĩnh Tuy, Quận Hai Bà Trưng, Hà Nội" required></textarea>
                        </div>
