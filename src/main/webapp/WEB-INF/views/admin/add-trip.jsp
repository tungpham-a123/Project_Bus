...
<html lang="vi">
    <head>
        ...
        <title>Phân Công Chuyến Đi - Admin</title>
        ...
        <div class="main-content">
            ...
            <main class="content-body">
                <div class="breadcrumbs">
                    ...
                    <span>&gt;</span>
                    <a href="<c:url value='/admin/trips'/>">Quản lý chuyến đi</a>
                    <span>&gt;</span>
                    Phân công mới
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h2>Phân công chuyến đi mới</h2>
                    </div>

                    <form action="<c:url value='/admin/trips/add'/>" method="post">
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <select id="monitorId" name="monitorId" required>
                                    <c:forEach var="monitor" items="${monitors}">
                                        <option value="${monitor.id}">${monitor.fullName}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            <div class="form-actions">
                                <a href="<c:url value='/admin/trips'/>" class="btn btn-secondary">
                                    <i class="fas fa-times"></i> Hủy
                                </a>
                                <button type="submit" class="btn btn-success">
                                    <i class="fas fa-plus-circle"></i> Tạo Chuyến Đi
                                </button>
                            </div>
                        </div>
                    </form>
