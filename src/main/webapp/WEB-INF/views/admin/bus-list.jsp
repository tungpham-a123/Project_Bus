...
<html lang="vi">
    <head>
        ...
        <title>Quản lý Xe Buýt - Admin</title>
        ...
        <div class="main-content">
            ...
            <main class="content-body">
                <div class="page-header">
                    <h2 class="page-title">Quản lý Xe Buýt</h2>
                    <a href="<c:url value='/admin/buses/add' />" class="btn btn-success">
                            ...
                            <tbody>
                                <c:forEach var="bus" items="${buses}">
                                    <tr>
                                        ...
                                        <td>${bus.capacity}</td>
                                        <td>
                                            <c:set var="status" value="${bus.status}" />
                                            <c:set var="badgeClass" value="badge-secondary" />
                                            <c:if test="${status == 'active'}"><c:set var="badgeClass" value="badge-success" /></c:if>
                                            <c:if test="${status == 'maintenance'}"><c:set var="badgeClass" value="badge-warning" /></c:if>

                                                <span class="status-badge ${badgeClass}">${status}</span>
                                        </td>
                                        <td class="actions">
                                            <a href="<c:url value='/admin/buses/edit/${bus.id}' />" class="action-edit" title="Sửa">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="<c:url value='/admin/buses/delete/${bus.id}' />" class="action-delete" title="Xóa"
                                               onclick="return confirm('Bạn có chắc chắn muốn xóa xe [${bus.licensePlate}] không?');">
