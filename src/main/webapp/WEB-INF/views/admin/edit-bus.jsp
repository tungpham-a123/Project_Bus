...
<html lang="vi">
    <head>
        ...
        <title>Sửa Thông Tin Xe Buýt - Admin</title>
    ...
    <body>
        <aside class="sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-nav-item active"><a href="<c:url value='/admin/buses' />"><i class="fas fa-bus-alt nav-icon"></i> Quản lý xe buýt</a></li>
        ...
        <div class="main-content">
            ...
            <main class="content-body">
                <div class="breadcrumbs">
                    ...
                    <span>&gt;</span>
                    <a href="<c:url value='/admin/buses'/>">Quản lý xe buýt</a>
                    <span>&gt;</span>
                    Sửa thông tin
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h2>Sửa thông tin xe buýt</h2>
                        <p>Biển số xe: <strong>${bus.licensePlate}</strong></p>
                    </div>

                    <form action="<c:url value='/admin/buses/edit'/>" method="post">
                        <input type="hidden" name="id" value="${bus.id}">

                        <div class="form-group">
                            <label for="licensePlate"><i class="fas fa-id-card"></i> Biển số xe</label>
                            <input type="text" id="licensePlate" name="licensePlate" value="${bus.licensePlate}" required>
                        </div>
                        <div class="form-group">
                            <label for="capacity"><i class="fas fa-users"></i> Số ghế</label>
                            <input type="number" id="capacity" name="capacity" value="${bus.capacity}" required min="1">
                        </div>
                        <div class="form-group">
                            <label for="status"><i class="fas fa-toggle-on"></i> Trạng thái</label>
                            <select id="status" name="status">
                                <option value="active" ${bus.status == 'active' ? 'selected' : ''}>Hoạt động</option>
                                <option value="maintenance" ${bus.status == 'maintenance' ? 'selected' : ''}>Bảo trì</option>
                                <option value="out_of_service" ${bus.status == 'out_of_service' ? 'selected' : ''}>Ngừng hoạt động</option>
                            </select>
                        </div>

                        <div class="form-actions">
                            <a href="<c:url value='/admin/buses'/>" class="btn btn-secondary">
