...
<html lang="vi">
    <head>
        ...
        <title>Sửa Điểm Dừng Trên Tuyến - Admin</title>
        ...
        <style>
            ...
            * {
            ...
            .form-group input, .form-group .form-control-static {
                width: 100%;
            ...
            <main class="content-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2>Sửa điểm dừng trên tuyến</h2>
                        <p>Tuyến: <strong>${route.routeName}</strong></p>
                    </div>

                    <form action="<c:url value='/admin/routes/edit-stop'/>" method="post">
                        <input type="hidden" name="routeId" value="${route.id}">
                        <input type="hidden" name="stopId" value="${routeStop.stop.id}">

                        <div class="form-group">
                            <label><i class="fas fa-map-pin"></i> Điểm dừng</label>
                            <div class="form-control-static">${routeStop.stop.stopName}</div>
                        </div>

                        <div class="form-group">
                            <label for="stopOrder"><i class="fas fa-sort-numeric-up"></i> Thứ tự trên tuyến</label>
                            <input type="number" id="stopOrder" name="stopOrder" value="${routeStop.stopOrder}" required min="1">
                        </div>

                        <div class="form-group">
                            <label for="estimatedPickupTime"><i class="fas fa-clock"></i> Giờ đón dự kiến</label>
                            <fmt:formatDate value="${routeStop.estimatedPickupTime}" pattern="HH:mm" var="formattedTime" />
                            <input type="time" id="estimatedPickupTime" name="estimatedPickupTime" value="${formattedTime}" required>
                        </div>
