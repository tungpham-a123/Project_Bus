...
<html lang="vi">
    <head>
        ...
        <title>Sửa Thông Tin Tuyến Xe - Admin</title>
            ...
            <main class="content-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2>Sửa thông tin tuyến xe</h2>
                    </div>

                    <form action="<c:url value='/admin/routes/edit'/>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" rows="4">${route.description}</textarea>
                        </div>
