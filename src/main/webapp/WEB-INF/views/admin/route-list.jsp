...
<html lang="vi">
    <head>
        ...
        <title>Quản lý Tuyến Xe - Admin</title>
        ...
        <div class="main-content">
            ...
            <main class="content-body">
                ...
                <div class="page-header">
                    ...
                    <a href="<c:url value='/admin/routes/add' />" class="btn btn-success">
                        <i class="fas fa-plus-circle"></i> Thêm tuyến mới
                    </a>
                </div>
                            ...
                            <tbody>
                                <c:forEach var="route" items="${routes}">
                                    <tr>
                                        ...
                                        <td class="actions">
                                            <a href="<c:url value='/admin/routes/details/${route.id}' />" class="action-view" title="Xem chi tiết">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="<c:url value='/admin/routes/edit/${route.id}' />" class="action-edit" title="Sửa">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="<c:url value='/admin/routes/delete/${route.id}' />" class="action-delete" title="Xóa"
                                               onclick="return confirm('Bạn có chắc chắn muốn xóa tuyến xe [${route.routeName}] không? Hành động này không thể hoàn tác.');">
                                ...
                                <c:if test="${empty routes}">
                                    <tr>
                                        <td colspan="4" style="text-align: center; padding: 2rem;">Chưa có tuyến xe nào trong hệ thống.</td>
                                    </tr>
                                </c:if>
                            </tbody>
                        </table>
