...
<html lang="vi">
    <head>
        ...
        <title>Quản lý Điểm Dừng - Admin</title>
        ...
        <div class="main-content">
            ...
            <main class="content-body">
                ...
                <div class="page-header">
                    <h2 class="page-title">Quản lý Điểm Dừng</h2>
                    <a href="<c:url value='/admin/stops/add' />" class="btn btn-success">
                        <i class="fas fa-plus-circle"></i> Thêm điểm dừng mới
                    </a>
                </div>
                        ...
                        <table class="data-table">
                            ...
                            <tbody>
                                <c:forEach var="stop" items="${stops}">
                                    <tr>
                                        <td>${stop.id}</td>
                                        <td><strong>${stop.stopName}</strong></td>
                                        <td>${stop.address}</td>
                                        <td class="actions">
                                            <a href="<c:url value='/admin/stops/edit/${stop.id}' />" class="action-edit" title="Sửa">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="<c:url value='/admin/stops/delete/${stop.id}' />" class="action-delete" title="Xóa"
                                               onclick="return confirm('Bạn có chắc chắn muốn xóa điểm dừng [${stop.stopName}] không? Điểm dừng này cũng sẽ bị gỡ khỏi tất cả các tuyến xe.');">
                                ...
                                <c:if test="${empty stops}">
                                    <tr>
                                        <td colspan="4" style="text-align: center; padding: 2rem;">Chưa có điểm dừng nào trong hệ thống.</td>
                                    </tr>
                                </c:if>
                            </tbody>
                        </table>
